    ...
    <title>SGD</title>
     ...
     $(document).ready(function(){
      ...
      //utilizo el ajax para traer los datos directamente del controlador
        ...
        { targets: 14, width:81, orderable: false, searchable: false, 
    ...
    $( "#tabla tbody" ).on( "click", ".accDel", function() {
      ...
      var item = $("#tabla").DataTable().row( $(this).parents('tr') ).data();
        ...
        $("#cargar").click(function(e){
            ...
            agregarT($("#select_clientes").val(), $("#select_Referente").val(), $("#select_tipo_trabajo").val(), $("#nombre_corto").val(), $("#descripcion").val(), $("#fecha_inicio").val(), $("#fecha_entrega").val(), $("#importe").val());
            }  
        });
